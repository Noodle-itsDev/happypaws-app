...
import Logo from '../src/assets/whiteAPaws.png';
  ...
  return (
    <Box
      ...
      sx={{
        ...
        background: 'linear-gradient(90deg, rgba(255,222,89,1) 0%, rgba(255,176,82,1) 49%, rgba(255,145,77,1) 100%, rgba(126,217,87,1) 100%)',
